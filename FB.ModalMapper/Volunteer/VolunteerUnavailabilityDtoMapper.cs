...
{
    public class VolunteerUnavailabilityDtoMapper
    {
        public static List<UnavailabilityDto> UnavaillibilityListgMap(List<VolunteerUnavailability> unavailabilityItems)
        {
            var unavailabilityList = new List<UnavailabilityDto>();
            foreach (var item in unavailabilityItems)
            {
                unavailabilityList.Add(new UnavailabilityDto
                {
        ...
        public static string MapPattern(VolunteerUnavailability entity)
        {
