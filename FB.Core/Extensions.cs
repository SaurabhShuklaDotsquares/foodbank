...
namespace FB.Core
{
    public static class Extensions
    {
        ...
        public static IQueryable<T> OrderByDescending<T>(this IQueryable<T> source, DataTableServerSide searchCriteria, Type[] childTypes = null)
        {
            return (IQueryable<T>)CustomPredicate.BuildOrderByDescending(source, searchCriteria, childTypes);
        }
