...
namespace FB.Core
{
    ...
    public enum Professions
    {
        ...
        GovernmentEmployee = 2
    }

    public enum DonationStatus
    {
        [Display(Name = "Pledged")]
        Pledged = 0,
        [Display(Name = "Pledged & Donated")]
        PledgedAndDonated = 1
    }
    ...
    public enum eFamilyReferred : int
    {
        Self = 1,
        ByReferrer = 2,
        Manual = 3
    }
    public enum AchievementBadges
    {
    ...
    {
        [Display(Name = "Be-spoke Parcel")]
        Bespoke = 0,
        [Display(Name = "Standard Parcel")]
        Standard = 1,
        [Display(Name = "Anonymous Parcel")]
        AnonymousParcel = 2,
    }
    public enum FamilyReportSatus
    {
        Approved = 0,
        Pending = 1,
        Both = 2
    ...
    {
        [Display(Name = "ReffersReport")]
        ReffersReport,
        [Display(Name = "FamilyReport")]
        FamilyReport,
        [Display(Name = "ParcelsReport")]
        ParcelsReport,
        [Display(Name = "GrantorsReport")]
        GrantorsReport,
        [Display(Name = "VolunteersReport")]
        VolunteersReport
