...
(function ($) {
    ...
    function PersonIndex() {
        ...
        function InitializeOnLoadSection() {
            ...
            $("#LastReference").off("click").on("click", function () {
                ...
                if (branchvalue == "") {
                    ...
                    $.ajax({
                        url: Global.DomainName + "account/GetLastReference?BranchIds=" + branchvalue,
                        type: "Get",
        ...
        function GetReferenceType(branchvalue) {
            if (branchvalue.indexOf(",") < 0) {
                $.get(Global.DomainName + "account/GetReferenceType", { BranchId: branchvalue }, function (result) {
                    if (result.isSuccess) {
                        if (result.data == 1) {
