...
function SearchIdEnd(response) {
    ...
    if (response != null && response['Error'] != null) {
        ...
        if (response.length == 0) {
            ...
            if (urlToCheck.indexOf("donor") != -1 || urlToCheck.indexOf("referrer") != -1 || urlToCheck.indexOf("family") != -1 || urlToCheck.indexOf("regulargift") != -1 || urlToCheck.indexOf("member") != -1 || urlToCheck.indexOf("certificateissuer") != -1 || urlToCheck.indexOf("foodbank") != -1) {
