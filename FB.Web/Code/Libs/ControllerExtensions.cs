...
namespace FB.Web
{
    public static class ControllerExtensions
    {
        ...
        /// <returns></returns>
        public static async Task<string> RenderViewToStringAsync<TModel>(this Controller controller, string viewNamePath, TModel model, ViewDataDictionary viewData, ITempDataDictionary tempData)
        {
